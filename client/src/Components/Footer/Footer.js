        ...
        <div uk-grid='true'>
          ...
          <div className='uk-width-1-1 uk-hidden@m uk-margin-remove-top uk-margin-small-bottom'>
            <div className='uk-text-center'>
              <p style={{color:'black'}} className='uk-margin-remove-bottom'><b>CALL US !</b></p>
              <a style={{color:'black'}} className='uk-margin-remove-top' href="tel:630 292 0176">630-292-0176</a>
              <p style={{color:'black'}} className='uk-margin-remove-bottom'><b>FIND US !</b></p>
              <a style={{color:'black'}} className='uk-margin-remove-top ' href="https://www.google.com/maps/search/?api=1&origin=39.684620,-104.936880">1780 S Bellaire St. #260 Denver, CO</a>
