        ...
        <div uk-grid='true'>
          ...
          <div className='uk-width-1-1 uk-hidden@m uk-margin-remove-top uk-margin-small-bottom'>
            <div className='uk-text-center'>
              ...
              <a style={{color:'white'}} className='uk-margin-remove-top ' href="https://www.google.com/maps/search/?api=1&query=39.684620,-104.936880">1780 S Bellaire St. #260 <br></br> Denver, CO 80222</a>
